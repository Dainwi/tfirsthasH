...
<div class="card shadow card-bg p-4">
    ...
    <div class="tab-content" id="ex1-content">
        <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
            <div class="mt-3 table-responsive">
                <table class="table ">
                    ...
                    <tbody>
                        <?php
                       $sql_emp = "SELECT u_id, user_name, user_photo, user_role FROM users_db WHERE cus_id={$cusID} AND user_active=1 ORDER BY payment_option ASC";
                       $res_emp = mysqli_query($con, $sql_emp);
                       
                       if (!$res_emp) {
                           // If the query fails, log the error
                           error_log("SQL error in employee query: " . mysqli_error($con));
        ...
        <div class="tab-pane fade" id="ex1-tabs-2" role="tabpanel" aria-labelledby="ex1-tab-2">
            <?php
            $sql = "SELECT * FROM users_db WHERE user_active=1 AND cus_id={$cusID} ORDER BY payment_option ASC";
                                    ...
                                    <div class="row">
                                            ...
                                            if ($row['user_role'] == 1) {
                                                ...
                                                if ($res_type) {
                                                    while ($r_type = mysqli_fetch_assoc($res_type)) {
                                                        $rolee = $r_type['type_name'];
                                                        array_push($result_array2, $rolee);
                                                        // $etype = "<span class='small text-light'>" . $r_type['type_name'] . "," . "</span> ";
                                                    }
                                                    $etype = implode(', ', $result_array2);
                                                }
                                            }
                                        ...
                                        ?>
                                            ...
                                            <tr class="border">
                                                ...
                                                <td class="text-center"><a href="<?php echo $url . "/admin/attendance/view-attendance.php?user=" . $user_id; ?>" class="btn btn-secondary btn-sm ">View</a></td>
