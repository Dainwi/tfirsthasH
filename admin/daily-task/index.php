                        ...
                        <div class="border border-dark table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <div class="row">
                                        <?php
                                        $sql = "SELECT * FROM daily_tasks LEFT JOIN users_db ON users_db.u_id = daily_tasks.dt_user_id WHERE daily_tasks.cus_id={$cusID} AND dt_date ='{$date}' ORDER BY dt_id DESC";
                                                            ...
                                                            if ($userrole == 1) {
                                                                ...
                                                                if (mysqli_num_rows($res2) > 0) {
                                                                    while ($r_type2 = mysqli_fetch_array($res2)) {
                                                                        ...
                                                                        array_push($result_array1, $rolee);
                                                                    }
                                                                    $List1 = implode(', ', $result_array1);
                                                                    echo $List1;
                                                                }
                                                            }
                                                            ?>
            ...
            <div class="card round-10">
                <div class="card-body">
                    ...
                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="user-role"> <small>
                                                        ...
                                                        if ($userrole1 == 1) {
                                                            ...
                                                            $result_array11 = array();
                                                            $sql21 = "SELECT users_db.u_id,employee_position.*,employee_type.* FROM users_db INNER JOIN employee_position ON users_db.u_id = employee_position.ep_user_id INNER JOIN employee_type ON employee_position.ep_type = employee_type.type_id WHERE users_db.u_id={$usid1}";
                                                            $res21 = mysqli_query($con, $sql21);
                                                            if (mysqli_num_rows($res21) > 0) {
                                                                while ($r_type21 = mysqli_fetch_array($res21)) {
                                                                    $rolee1 = $r_type21['type_name'];
                                                                    array_push($result_array11, $rolee1);
                                                                }
                                                                $List11 = implode(', ', $result_array11);
                                                                echo $List11;
                                                            }
                                                        }
                                                        ?></small></td>
                        ...
                        <p class="text-center mt-4"><a href="<?php echo $url . "/admin/daily-task/pending-tasks.php"; ?>">view all</a></p>
                    <?php
                    } else {
            ...
            <div class="card shadow-box round-10">
                <div class="card-body">
                    ...
                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="user-role"> <small>
                                                        ...
                                                        if ($userrole2 == 1) {
                                                            ...
                                                            $result_array12 = array();
                                                            $sql22 = "SELECT users_db.u_id,employee_position.*,employee_type.* FROM users_db INNER JOIN employee_position ON users_db.u_id = employee_position.ep_user_id INNER JOIN employee_type ON employee_position.ep_type = employee_type.type_id WHERE users_db.u_id={$usid1}";
                                                            $res22 = mysqli_query($con, $sql22);
                                                            if (mysqli_num_rows($res22) > 0) {
                                                                while ($r_type22 = mysqli_fetch_array($res22)) {
                                                                    $rolee2 = $r_type22['type_name'];
                                                                    array_push($result_array12, $rolee2);
                                                                }
                                                                $List12 = implode(', ', $result_array12);
                                                                echo $List12;
                                                            }
                                                        }
                                                        ?></small></td>
                        ...
                        <p class="text-center mt-4"><a href="<?php echo $url . "/admin/daily-task/completed-tasks.php"; ?>">view all</a></p>
                    <?php
                    } else {
                ...
                <div class="modal-body pb-4">
                    ...
                    <div class="m-b-15">
                        <select class="form-control" name="emp_assign" id="emp-select">
                            ...
                            <?php
                            $sql_emp = "SELECT u_id,user_name,user_photo,user_role FROM users_db WHERE payment_option = 0 AND user_active=1 AND cus_id={$cusID}";
