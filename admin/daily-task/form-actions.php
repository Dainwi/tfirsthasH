...
// Now, when you use the PHP date function, it will be in IST
// $currentDateTimeIST = date('Y-m-d H:i:s');

// Use this variable in your SQL query
// $sql = "INSERT INTO your_table (datetime_column) VALUES ('{$currentDateTimeIST}')";


    $sql = "INSERT INTO daily_tasks(dt_user_id, dt_details, dt_date, dt_due_date, cus_id) VALUES('{$empid}', '{$task}', '{$taskDate}', '{$due_date}', '{$cusID}')";
