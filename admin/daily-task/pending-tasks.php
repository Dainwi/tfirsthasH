    ...
    <div class="card-footer">
        <nav aria-label="Page navigation example">
            ...
            if (mysqli_num_rows($res_pg) > 0) {
                ...
                if ($page > 1) {
                    echo "<li class='page-item'><a class='page-link' href='{$url}/admin/daily-task/pending-tasks.php?page=" . ($page - 1) . "'>Prev</a></li>";
                } else {
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    echo '<li class="page-item ' . $active . '"><a class="page-link" href="' . $url . '/admin/daily-task/pending-tasks.php?page=' . $i . '">' . $i . '</a></li>';
                }
                if ($total_page > $page) {
                    echo "<li class='page-item'><a class='page-link' href='{$url}/admin/daily-tasks/pending-tasks.php?page=" . ($page + 1) . "'>Next</a></li>";
                } else {
