...
<div class="container-fluid">
    <div class="card shadow rounded card-bg">
        <div class="card-body">
            ...
            <?php
            $sql1 = "SELECT *,users_db.user_name,users_db.u_id FROM  daily_tasks LEFT JOIN users_db ON daily_tasks.dt_user_id = users_db.u_id WHERE dt_manager_status = 1 AND dt_date !='{$date}' ORDER BY dt_id DESC LIMIT {$offset},{$limit}";
    ...
    <div class="card-footer">
        <nav aria-label="Page navigation example">
            ...
            if (mysqli_num_rows($res_pg) > 0) {
                ...
                if ($page > 1) {
                    echo "<li class='page-item'><a class='page-link' href='{$url}/admin/daily-task/completed-tasks.php?page=" . ($page - 1) . "'>Prev</a></li>";
                } else {
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    echo '<li class="page-item ' . $active . '"><a class="page-link" href="' . $url . '/admin/daily-task/completed-tasks.php?page=' . $i . '">' . $i . '</a></li>';
                }
                if ($total_page > $page) {
                    echo "<li class='page-item'><a class='page-link' href='{$url}/admin/daily-task/completed-tasks.php?page=" . ($page + 1) . "'>Next</a></li>";
                } else {
