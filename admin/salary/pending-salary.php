<?php
define('TITLE', 'Salary');
define('PAGE', 'pending-salary');
define('PAGE_T', ' Salary - Pending');
...
<div class="card shadow card-bg p-4">
    ...
    <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
        <li class="nav-item me-3" role="presentation">
            <a class="nav-link active" id="ex1-tab-1" data-bs-toggle="tab" href="#ex1-tabs-1" role="tab"
                aria-controls="ex1-tabs-1" aria-selected="true">In-house</a>
        </li>
        <li class="nav-item mx-3" role="presentation">
            <a class="nav-link" id="ex1-tab-2" data-bs-toggle="tab" href="#ex1-tabs-2" role="tab"
                aria-controls="ex1-tabs-2" aria-selected="false">Freelancer</a>
        </li>
    ...
    <div class="tab-content" id="ex1-content">
        <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
            <?php
            $sql = "SELECT * FROM users_db WHERE user_role !=0 AND payment_option = 0 AND user_active=1 AND cus_id={$cusID}";
                            ...
                            <?php while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                if ($amt_due == 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="name text-light"><input type='hidden' value='<?php echo $row['u_id'] ?>'
                                                name='emp_id'><a type="button" class="btn-view text-light">
                            ...
                            while ($row_taskUser = mysqli_fetch_assoc($res_taskUser)) {
                                ...
                                if ($numTask > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="name1"><input type='hidden' value='<?php echo $use_id ?>' name='emp_id'><a
                                                type="button" class="btn-view text-light">
                                                <?php echo $use_name; ?>
                                            </a></td>
                                        <td class="type1">
                                            <?php
                                            $sql_role = "SELECT users_db.u_id,employee_position.*,employee_type.* FROM users_db INNER JOIN employee_position ON users_db.u_id = employee_position.ep_user_id INNER JOIN employee_type ON employee_position.ep_type = employee_type.type_id WHERE users_db.u_id={$use_id}";
        ...
        <div class="modal-content card-bg">
            ...
            <form id='updateSalaryForm' method='post'>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="submit" class="btn btn-secondary btn-tone" id="btn-update-salary">update <i
