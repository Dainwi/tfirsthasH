...
<div class="container-fluid">
    <div class="table-responsive">
        <table class='table table-sm table-bordered card-bg'>
            ...
            <tbody>";
                $sql4 = "SELECT * FROM deliverables_assign LEFT JOIN deliverables_db ON deliverables_db.d_id=deliverables_assign.da_d_id WHERE da_assign_to={$manager_id} AND da_status=0 ORDER BY da_due_date ASC LIMIT {$offset},{$limit}";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-info"><input type='hidden' name='delivId' id='task-id' value='<?php echo $row4["da_id"] ?>'>
                                ...
                                <select class="form-control input-state text-info taskType" name="empType">
    ...
    <div class="card-footer">
        <nav aria-label="Page navigation example">
            ...
            if (mysqli_num_rows($res_pg) > 0) {
                ...
                $sql_pg1 = "SELECT * FROM deliverables_assign WHERE da_assign_to ={$manager_id} AND da_status=0";
...
<script>
    ...
    $("#save_eventype").click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo $url . "/manager/tasks/task-ajax.php"; ?>",
            data: {
                newestatustype: true,
                etitle: ettile,
            },
