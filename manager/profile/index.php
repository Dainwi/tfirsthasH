...
$sql_profile = "SELECT * FROM users_db WHERE u_id={$manager_id}";
...
<div class="container">
                        ...
                        <div class="text-center text-sm-left m-v-15 p-l-30">
                            ...
                            <p class="text-info m-b-20">
                                <?php if ($utype == 1) {
                                    ...
                                    $sqlt = "SELECT * employee_position LEFT JOIN employee_type ON employee_position.ep_type = employee_type.type_id WHERE employee_position.ep_user={$manager_id}";
    ...
    <!-- bank card  -->
    <?php
    $sqlBank = "SELECT * FROM payment_information WHERE pi_user_id= {$manager_id}";
        ...
        <div class="card-body">
            <form method="POST" action="ajax-profile.php">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <input type="hidden" name="admin-id" value="<?php echo $manager_id ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content card-bg">
            ...
            <div class="modal-body mx-3">
                ...
                <input type="hidden" value="<?php echo $manager_id; ?>" id="uidd">
                <div class="md-form mb-3">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content card-bg">
            ...
            <form action="update-profile.php" method="post">
                <div class="modal-body mx-3">
                    <input type="hidden" value="<?php echo $manager_id; ?>" name="empid">
...
<div class="modal fade bd-example-modal-lg" id="modalEditBank" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content card-bg">
            ...
            <form action="update-profile.php" method="post">
                <div class="modal-body mx-3">
                    <input type="hidden" value="<?php echo $manager_id; ?>" name="empid1">
