...
$sql = "SELECT payment_option FROM users_db WHERE u_id={$employee_id}";
    ...
    <div class="card card-bg rounded">
            ...
            <?php } else { ?>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql3 = "SELECT * FROM assign_requirements WHERE ar_assign_to={$employee_id} AND ar_paid_status =1 ORDER BY ar_paid_date DESC LIMIT {$offset},{$limit}";
                            $res3 = mysqli_query($con, $sql3);
                            if (mysqli_num_rows($res3) > 0) {
                                $ii2 = $offset + 1;
                            ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-light"> Rs. <?php echo $amnt; ?></td>
                                ...
                                $sql4 = "SELECT * FROM deliverables_assign WHERE da_assign_to={$employee_id} AND da_paid_status=1 ORDER BY da_paid_date DESC LIMIT {$offset},{$limit}";
                                ...
                                if (mysqli_num_rows($res4) > 0) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-light"> Rs. <?php echo $row4['da_amount']; ?></td>
        ...
        <div class="card-footer">
            <nav aria-label="Page navigation example">
                <?php
                if ($paymentType == 0) {
                    $sql_pg = "SELECT * FROM salary_details WHERE sd_user_id={$employee_id}";
                    ...
                    if (mysqli_num_rows($res_pg) > 0) {
                        ...
                        if ($page > 1) {
                            echo "<li class='page-item'><a class='page-link' href='{$url}/employee/payments/index.php?pg=" . ($page - 1) . "'>Prev</a></li>";
                        } else {
                        ...
                        for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            echo '<li class="page-item ' . $active . '"><a class="page-link" href="' . $url . '/employee/payments/index.php?pg=' . $i . '">' . $i . '</a></li>';
                        }
                        if ($total_page > $page) {
                            echo "<li class='page-item'><a class='page-link' href='{$url}/employee/payments/index.php?pg=" . ($page + 1) . "'>Next</a></li>";
                        } else {
                    ...
                    $sql_pg = "SELECT * FROM assign_requirements WHERE ar_paid_status =1 AND ar_assign_to ={$employee_id}";
                    $res_pg = mysqli_query($con, $sql_pg);
                    if (mysqli_num_rows($res_pg) > 0) {
                        ...
                        $sql_pg1 = "SELECT * FROM deliverables_assign WHERE da_assign_to ={$employee_id} AND da_paid_status=1";
                        ...
                        if (mysqli_num_rows($res_pg1) > 0) {
                            ...
                            for ($i = 1; $i <= $total_page; $i++) {
                                ...
                                echo '<li class="page-item ' . $active . '"><a class="page-link" href="' . $url . '/employee/payments/index.php?pg=' . $userId . '&pg=' . $i . '">' . $i . '</a></li>';
                            }
                            if ($total_page > $page) {
                                echo "<li class='page-item'><a class='page-link' href='{$url}/employee/payments/index.php?pg=" . ($page + 1) . "'>Next</a></li>";
                            } else {
