    ...
    <nav class="navbar navbar-expand-lg d-flex justify-content-between">
        ...
        <div class="flex-fill" id="headerNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link profile-dropdown" href="#" id="profileDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="rounded-circle" style="height:36px" src="<?php
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-drop-menu" aria-labelledby="profileDropDown">
                        <a class="dropdown-item" href="<?php echo $url . "/employee/profile"; ?>"><i data-feather="user"></i>Profile</a>

                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i data-feather="settings"></i>Settings</a>
                        <a class="dropdown-item" href="#"><i data-feather="unlock"></i>Lock</a>
                        <a class="dropdown-item" href="<?php echo $url . "/employee/include/logout.php"; ?>"><i data-feather="log-out"></i>Logout</a>
                    </div>
                </li>
            </ul>
        </div>
