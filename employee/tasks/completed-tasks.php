    ...
    <div class="row">
        <table class='table table-sm table-bordered card-bg'>
            ...
            ?>
                ...
                $sql4 = "SELECT * FROM deliverables_assign WHERE da_assign_to={$employee_id} AND da_status=1 ORDER BY da_due_date ASC LIMIT {$offset},{$limit}";
    ...
    <div class="card-footer">
        <nav aria-label="Page navigation example">
            ...
            if (mysqli_num_rows($res_pg) > 0) {
                ...
                $sql_pg1 = "SELECT * FROM deliverables_assign WHERE da_assign_to ={$employee_id} AND da_status=1";
