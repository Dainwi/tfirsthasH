                        ...
                        <form action="actions/login-actions.php" method="POST">
                            <div class="mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingName" placeholder="Full Name" name="client_name">
                                    <label for="floatingName">Full Name</label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="floatingPhone" placeholder="Phone" name="phone">
                                    <label for="floatingPhone">Phone</label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="floatingEmail" placeholder="Email Id" name="email">
                            ...
                            <div class="d-grid">
                                ...
                                <button type="submit" class="btn btn-warning btn-firsthash m-b-xs mt-4 border-none">Sign Up</button>

                            </div>
                        </form>
                        <div class="">
                            <p class="text-center">Already have account. <a href="<?php echo $url . "/clients/index.php" ?>" class="text-info ms-3">Sign In</a> </p>
                        </div>
                    </div>
                </div>
            </div>
